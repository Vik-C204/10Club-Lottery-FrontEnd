import {Box, Button, Center, Flex, Heading, HStack, Spacer, Text, useMediaQuery, VStack} from "@chakra-ui/react";
  ...
  return (
    ...
    >
      ...
      <Spacer />
        ...
        <Box className="custom-shape-divider-top-1664755733" bgGradient={'linear(to-r, #7C82FF,teal.400 )'} position={"relative"} zIndex={"2"} mb={"-70vh"}>
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M1200 120L0 16.48 0 0 1200 0 1200 120z" className="shape-fill"></path>
          </svg>
        </Box>
